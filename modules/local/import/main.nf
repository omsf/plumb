...
process PROCESS_BINDINGDB_W_CH {
    ...
    */
    ...
    // Publish output files to an intermediate directory, copying and overwriting if necessary
    publishDir file("${projectDir}/intermed_data_temp"), mode: 'copy', overwrite: true

    // Define input variables
    input:
    path sdf_file // The directory containing the SDF files
    ...
    # Run the Python script with the input directory
    python ${projectDir}/bin/process_bindingdb_w_channels.py --input-file ${sdf_file}
    """
}